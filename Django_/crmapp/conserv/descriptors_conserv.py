...
class Descriptor:
    ...
    def conservation_scores(self):
        """
        Calculates conservation scores among some of the most relevant virus' families.

        :return: dictionary with values of conservation scores

        """
        res = self.scores_sequence(self.ProteinSequence, len(self.ProteinSequence)-1)
    ...
    def get_all(self, ph=7, amide=False, tricomp=False, bin_aa=False, bin_prop=False, lamda_paac=10, weight_paac=0.05,
        ...
        res.update(self.conservation_scores())
    ...
    def scores_dataset(self):
        ...
        for index, row in dataset.iterrows():
            ...
            for i in family_weblogo.keys():
                ...
                dict_seq[i]=self.read_weblogo(family_weblogo[i], sequence, pos_analysis)
